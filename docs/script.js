...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (isMac) {
    ...
    btnDownload.href = "https://github.com/ViktorVeselov/SmartCursorX/releases/latest/download/SmartCursorX-Mac-0.0.1-alpha-Installer.dmg";
    btnText.textContent = "Download for macOS (.dmg)";
    releaseMeta.textContent = "macOS DMG • Version 0.0.1-alpha • Cleaned by Scan";
  } else {
    // Default/dynamic shape for Windows platforms
    btnDownload.href = "https://github.com/ViktorVeselov/SmartCursorX/releases/latest/download/SmartCursorX-Windows-0.0.1-alpha-Setup.exe";
